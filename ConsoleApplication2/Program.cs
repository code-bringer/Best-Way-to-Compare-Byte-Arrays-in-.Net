    ...
    internal class Program
    {
        ...
        private static void DoInvestigationStep(double p_SizeMultiplier)
        {
            ...
            s_tableBuilder.AddRow(arraySize
                                  ...
                                  , string.Format("1 : {0:000.0}", (double)results.IStructuralEquatableTime / (double)bestTime)
                  );
        }
        ...
        private static long MeasureComparisonTime(Func<bool> p_Method, long p_PreviousTime, int p_MeasurementNumber)
        {
            GC.Collect();
        ...
        private static long GetMinimalMesuredValue(int p_MeasurementNumber, long p_PreviousValue, long p_MeasuredValue)
        {
